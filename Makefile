...
dev:
	...
	$(DOCKER_COMPOSE) -f docker-compose.dev.yml exec -T app agent_delta db upgrade
	@echo ""
...
stage:
	...
	$(DOCKER_COMPOSE) -f docker-compose.yml exec -T app agent_delta db upgrade
...
prod:
	...
	@sleep 5
	$(DOCKER_COMPOSE) --env-file backend/.env -f docker-compose.prod.yml exec -T app agent_delta db upgrade
