...
|----------|---------|-------------|
| `PROJECT_NAME` | `agent_delta` | Display name for the project |
...
| `POSTGRES_DB` | `agent_delta` | Database name |
...
| `AI_FRAMEWORK` | `pydantic_deep` | AI framework (informational) |
...
| `LOGFIRE_SERVICE_NAME` | `agent_delta` | Service name in Logfire dashboard |
